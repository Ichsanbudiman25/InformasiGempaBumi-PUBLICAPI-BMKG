<?php
    $data = simplexml_load_file("https://data.bmkg.go.id/DataMKG/TEWS/gempadirasakan.xml") or die("Gagal");
    $i = 1;
?>
          ...
          <?php
            foreach($data->gempa as $gempadirasakan){
                echo "
                    <tr>
                        <td>".$i."</td>
                        <td>".$gempadirasakan->Tanggal."</td>
                        <td>".$gempadirasakan->Jam."</td>
                        <td>".$gempadirasakan->Magnitude."</td>
                        <td>".$gempadirasakan->Kedalaman."</td>
                        <td>".$gempadirasakan->Wilayah."</td>
                        <td>".$gempadirasakan->Potensi."</td>
                        ";
                $i++;
            }
          ?>
